 ...
 * Use the [OperatorBookingsFragment.newInstance] factory method to
...
class OperatorBookingsFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment OperatorBookingsFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            OperatorBookingsFragment().apply {
